  ...
  return (
    <div className='py-20 flex-wrap flex gap-5 justify-center px-3 group '>
      {SliderTwo_Card.map((card, index) => (
        <div key={index} className='w-[389px] h-[712px] border rounded-lg p-5 overflow-hidden hover:bg-[#FF5501] hover:text-white transition-all ease-linear duration-300 bg-[#fff] parent-card'>
          <div className=''>
